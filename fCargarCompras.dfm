object CargarCompras: TCargarCompras
  Left = 0
  Top = 0
  BorderStyle = bsDialog
  Caption = 'Cargar comprobantes de compras'
  ClientHeight = 488
  ClientWidth = 721
  Color = clBtnFace
  ...
  object EdProveedor: TEdit
    ...
    TabOrder = 5
    Text = '__-________-_'
    OnExit = EdProveedorExit
    OnKeyDown = EdProveedorKeyDown
    OnKeyPress = EdProveedorKeyPress
    OnKeyUp = EdProveedorKeyUp
    OnMouseUp = EdProveedorMouseUp
  end
  ...
  object EdCuentaCompra: TEdit
    ...
    ShowHint = False
    TabOrder = 9
    OnExit = EdCuentaCompraExit
    OnKeyPress = EdCuentaCompraKeyPress
    OnMouseUp = EdCuentaCompraMouseUp
  end
